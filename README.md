...
2. Python
Порядок запуска:
1. Установить все необходимые зависимости из файла requrements.txt
2. настроить файл settings под ваш redis в пункте RQ_QUEUES
3. запустить сервер 
python manage.py runserver
4. запустить подпроцессы для рассылки  
python manage.py rqworker --with-scheduler
5. http://127.0.0.1:8000/swagger/ - API Root
